# PRECISION: PaiREd miCrorna sImulation Study desIgn mOlecular classificatioN 
...
The package is currently availabe on GitHub. To load the package, type the following command in R console:
