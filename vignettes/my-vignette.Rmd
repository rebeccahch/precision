...
```{r precision.simulate.flex, eval = FALSE}
...
Even _Analysis with uniformly-handled data_ can be done using `precision.simulate.flex()`. A possible solution is as follows.

```{r precision.simulate.flex.uh, eval = FALSE}
...
```{r precision.vis.flex, eval = FALSE}
